...
const extern int WINDOW_PHYSICAL_WIDTH = 160 * 5;
const extern int WINDOW_PHYSICAL_HEIGHT = 144 * 5;
const int IMPORT_RESOLUTION = 128; //128 pixels high on the screen
const float VIRTUAL_SIZE = 8.0f; //How many units high the screen is, arbitrarily 
...
void Update()
{
    ...
    NetworkUpdate.Trigger(deltaSeconds);
...
void Initialize(HINSTANCE applicationInstanceHandle)
{
    ...
    NetSystem::instance = new NetSystem();
